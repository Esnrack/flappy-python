        ...
        if not powerup.collected:
            ...
            if dist_sq < (pr * pr):
                ...
                if powerup.type == 'life':
                    ...
                    config.invulnerable = True
                    boost_duration = 5.0
                    config.invulnerable_time = pause.get_game_time() + boost_duration
                    ...
                    config.heavy_jump_end_time = pause.get_game_time() + config.HEAVYJUMP_DURATION_SECONDS
                ...
                # --- ADICIONA LÓGICA PARA SHRINK ---
                    ...
                    config.shrink_end_time = pause.get_game_time() + config.SHRINK_DURATION_SECONDS
